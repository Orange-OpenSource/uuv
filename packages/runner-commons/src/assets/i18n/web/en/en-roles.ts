...
export const EN_ROLES: AccessibleRole[] = [
    ...
    { id: "cell", name: "cell" },
    { id: "checkbox", name: "checkbox", shouldGenerateKeyboardSentence: true, shouldGenerateClickSentence: true },
    ...
    { id: "radio", name: "radio", shouldGenerateKeyboardSentence: true, shouldGenerateClickSentence: true },
