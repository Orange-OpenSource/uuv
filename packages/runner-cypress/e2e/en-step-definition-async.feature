Feature: English Test Step Definition async
  ...
  Background:
    When I mock a request GET on url "http://localhost:9001/tests/uuvFixture.png" named "uuvFixture" with fixture mockUuv.jpg
    When I mock a request GET on url "http://localhost:9001/tests/uuvBody.png" named "uuvBody" with content "I am a content"
    When I mock a request GET on url "http://localhost:9001/tests/uuvStatus.png" named "uuvStatus" with status code 500
